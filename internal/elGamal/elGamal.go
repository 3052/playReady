...
// Encrypt encrypts a message point M using the recipient's public key P.
// The ciphertext consists of two points:
// C1 = k * G (where k is a random integer)
// C2 = M + k * P (where P is the recipient's public key)
func (e *ElGamalECC) Encrypt(randReader io.Reader, pub Point, msg Point) (c1, c2 Point, err error) {
...
// M = C2 - priv * C1
func (e *ElGamalECC) Decrypt(privKey *ecdsa.PrivateKey, c1, c2 Point) (msg Point, err error) {
