...
var key_tests = []struct {
...
}{
   {
      ...
      url:    "https://busy.any-any.prd.api.discomax.com/drm-proxy/any/drm-proxy/drm/license/play-ready?drmKeyVersion=1&auth=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Ke485bhP16A-gHMJWvYOPzJNy4vrP_uqxpxV_sQUrQc&x-wbd-tenant=beam&x-wbd-user-home-market=emea",
   },
   {
   ...
   },
   {
      ...
      url:    "https://prod-playready.rakuten.tv/v1/licensing/pr?uuid=a9d933d6-a5af-4223-add5-1d79046a1db6",
   },
   {
